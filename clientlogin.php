...
?>
    ...
    <body style="background-image:url('https://www.wticabs.com/images/Corporate_Car_Rental_case_studies.png'); height: 100%;position: relative;opacity: 0.9;background-attachment: fixed;background-position: center;background-repeat: no-repeat;
  background-size: cover;">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        ...
        <div class="container">
            <div class="jumbotron">
                <h1 class="text-center" style="color: darkblack; font-family:serif">CAR-RENTALS<br>EMPLOYEE PANEL </span>
                </h1>
                <br>
